...
case 'neko':
       ...
       case 'wallnime':
            ...
            case 'amongus':
             reply(mess.wait)
		    buff = await getBuffer(`https://api.lolhuman.xyz/api/sticker/${command}?apikey=${lolkey}`)
			kurr.sendMessage(from, wkwk, sticker, {quoted: ftrol})
			break
            ...
            reply(mess.wait)
             ...
             cewe = await getBuffer(anu.result.female)
              cowo = await getBuffer(anu.result.male)
               kurr.sendMessage(from, cowo, image, {quoted: ftrol, caption: 'Nih Versi Cowo Nya ^_^' })
               kurr.sendMessage(from, cewe, image, {quoted: ftrol, caption: 'Nih Versi Cewe Nya ^_^' })
              break
